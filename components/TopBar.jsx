...
export default function TopBar() {
  ...
  return (
<div className="max-w-full bg-[#2b6f95] text-white px-2 md:px-6 py-1 md:py-1.5">
        ...
        <div className="flex items-center gap-[4px] md:gap-3 whitespace-nowrap shrink-0">
              ...
              >
                {languages.map((lang) => (
                  <div
                    ...
                    onKeyDown={(e) => { if (e.key === "Enter") { setSelectedLang(lang); setLangOpen(false); } }}
                  ...
                  >
                    ...
                    {lang.native && (
                      <span lang={lang.lang} className="text-gray-500 text-[10px]">({lang.native})</span>
                    )}
                  </div>
                ))}
          ...
          {/* Skip Links */}
          <a href="#main-content" className="cursor-pointer hover:underline text-white no-underline">
            Skip to main content
          </a>
          <span className="opacity-60">|</span>
          <a href="#navigation" className="cursor-pointer hover:underline text-white no-underline">
            Skip to navigation
          </a>
