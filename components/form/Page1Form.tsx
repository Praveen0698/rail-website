...
export default function Page1Form({
  ...
  // Pure table cells — no block/table-cell toggling
  const cellLabel =
    ...
    <div className="min-h-screen bg-white p-3 lg:p-5 font-serif text-black text-[13px]">
      <div className="relative max-w-3xl mx-auto border border-gray-400 px-3 py-4 lg:px-8 lg:py-6 bg-white">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-end gap-4 mb-5">
          ...
          {/* Photo box */}
          <label className="block cursor-pointer shrink-0 self-center lg:self-auto">
            <div className="w-32 lg:w-35 min-h-36 lg:min-h-40 border border-black flex items-center justify-center text-center overflow-hidden relative group">
              {photo ? (
                <>
                  <img
                    src={photo}
        ...
        {/* Always a real table, scrollable on mobile */}
        <div className="overflow-x-auto">
          <table
            className="w-full border-collapse mt-0"
            style={{ minWidth: "480px" }}
          >
            <tbody>
              <tr>
                <td className={`${cellLabel} w-44`}>Employee Code</td>
        ...
        <div className="overflow-x-auto">
          ...
          >
            <tbody>
              ...
              <tr>
                ...
                <td className={cellInput} colSpan={3}>
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("nameOfFather", e.target.value)
                    }
                    className={bareInput}
                  />
                </td>
              ...
              <tr>
                ...
                <td className={cellInput} colSpan={3}>
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("nameOfMother", e.target.value)
                    }
                    className={bareInput}
                  />
                </td>
              ...
              <tr>
                <td className={cellLabel}>
                  Whether ex-servicemen? (yes or no)
                </td>
                <td className={cellInput}>
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      handleChange("exServicemen", e.target.value)
                    }
                    className={bareInput}
                  />
                </td>
              ...
              <tr>
                ...
                <td className={cellLabel}>Aadhar Card Number</td>
                <td className={cellInput}>
                  <input
                    type="text"
                    value={formData.aadharCardNumber}
                    onChange={(e) =>
                      handleChange("aadharCardNumber", e.target.value)
                    }
                    className={bareInput}
                  />
                </td>
              ...
              <tr>
                ...
                <td className={cellInput}>
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("spouseCaste", e.target.value)
                    }
                    className={bareInput}
                  />
                </td>
